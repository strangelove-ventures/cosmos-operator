...
Additionally, because full node state can be destroyed and recreated, the controller will destroy/recreate PVCs which is different from StatefulSets which never delete PVCs.
