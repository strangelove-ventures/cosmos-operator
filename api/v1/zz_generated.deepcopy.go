...
func (in *FullNodeSpec) DeepCopyInto(out *FullNodeSpec) {
	*out = *in
	in.Ordinal.DeepCopyInto(&out.Ordinal)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Ordinal) DeepCopyInto(out *Ordinal) {
	*out = *in
	if in.Start != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Ordinal.
func (in *Ordinal) DeepCopy() *Ordinal {
	if in == nil {
		return nil
	}
	out := new(Ordinal)
