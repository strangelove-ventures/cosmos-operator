...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodPatchSpec) DeepCopyInto(out *PodPatchSpec) {
	*out = *in
	if in.Volumes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodPatchSpec.
func (in *PodPatchSpec) DeepCopy() *PodPatchSpec {
	if in == nil {
		return nil
	}
	out := new(PodPatchSpec)
	in.DeepCopyInto(out)
	return out
}
