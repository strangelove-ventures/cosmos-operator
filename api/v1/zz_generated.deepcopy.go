...
func (in *ChainSpec) DeepCopyInto(out *ChainSpec) {
	*out = *in
	...
	in.CosmosSDK.DeepCopyInto(&out.CosmosSDK)
	in.Namada.DeepCopyInto(&out.Namada)
	if in.LogLevel != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Mempool) DeepCopyInto(out *Mempool) {
	*out = *in
	if in.TomlOverrides != nil {
		in, out := &in.TomlOverrides, &out.TomlOverrides
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Mempool.
func (in *Mempool) DeepCopy() *Mempool {
	if in == nil {
		return nil
	}
	out := new(Mempool)
