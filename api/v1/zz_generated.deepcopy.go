...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ChainVersions) DeepCopyInto(out *ChainVersions) {
	{
		in := &in
		*out = make(ChainVersions, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChainVersions.
func (in ChainVersions) DeepCopy() ChainVersions {
	if in == nil {
		return nil
	}
	out := new(ChainVersions)
	in.DeepCopyInto(out)
	return *out
}
