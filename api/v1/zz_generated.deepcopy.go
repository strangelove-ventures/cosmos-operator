...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CosmosServiceSpec) DeepCopyInto(out *CosmosServiceSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CosmosServiceSpec.
func (in *CosmosServiceSpec) DeepCopy() *CosmosServiceSpec {
	if in == nil {
		return nil
	}
	out := new(CosmosServiceSpec)
	in.DeepCopyInto(out)
	return out
}
