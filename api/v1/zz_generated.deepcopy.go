...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FullNodeMetadata) DeepCopyInto(out *FullNodeMetadata) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FullNodeMetadata.
func (in *FullNodeMetadata) DeepCopy() *FullNodeMetadata {
	if in == nil {
		return nil
	}
	out := new(FullNodeMetadata)
	in.DeepCopyInto(out)
	return out
}
