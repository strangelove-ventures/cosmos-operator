...
func (in *SelfHealSpec) DeepCopyInto(out *SelfHealSpec) {
	*out = *in
	...
	if in.StuckPodMitigation != nil {
		in, out := &in.StuckPodMitigation, &out.StuckPodMitigation
		*out = new(StuckPodMitigationSpec)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StuckPodMitigationSpec) DeepCopyInto(out *StuckPodMitigationSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StuckPodMitigationSpec.
func (in *StuckPodMitigationSpec) DeepCopy() *StuckPodMitigationSpec {
	if in == nil {
		return nil
	}
	out := new(StuckPodMitigationSpec)
